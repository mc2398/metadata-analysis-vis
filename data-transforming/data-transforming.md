...
7) [Author Data](data-transforming/datasets/goodreads_deduplicated_author_data.csv). Contains a row for each author of the included books.  Books have been already deduplicated.  Multiauthored books and repeat authors are identified.
